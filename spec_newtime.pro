FUNCTION spec_newtime, fn, data=data
   ...
   dbuffertime = [0, data.buffertime[1:*] - data.buffertime]
   itimematch = where(dbuffertime gt 0) - 1   ;We want to match buffertime to particletime at the end of each buffer
